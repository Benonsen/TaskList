            ...
            <div class="modal-body">
                <form class="form-signin">
                    <div class="form-label-group">
                        <input type="text" id="createTaskTitle" class="form-control" placeholder="Title" autofocus
                            autocomplete="off">
                    ...
                    <div class="form-label-group">
                        <input type="date" id="createTaskDate" class="form-control" placeholder="Date"
                    ...
                    <div class="form-group">
                        ...
                        <input type="range" min="0" max="100" value="50" step="10" class="form-control-range"
                            id="formControlRange">
                    ...
                    <button class="btn btn-lg btn-primary btn-block text-uppercase" type="button" style="margin-top:5%;"
                        data-dismiss="modal" onclick="createTask()">Save task</button>
                    <button class="btn btn-lg btn-primary btn-block text-uppercase" type="button" style="margin-top:3%;"
                        data-dismiss="modal" onclick="clearFormCreateTask()">Cancel</button>
