...
<form class="form-signin">
    ...
    <div class="form-group">
        ...
        <input type="range" min="0" max="100" value="<?php echo $taskedit[$indexarray]->priority ?>" step="10"
            class="form-control-range" id="EditformControlRange">
